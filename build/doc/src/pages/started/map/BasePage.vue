...
<template>
  <main-container>
    ...
    <p>
      Из примера можно заметить, что метод <b>setOut</b> отвечает за данные из источника данных, а метод <b>setIn</b> за свойства, которые относятся к сущности в которую производим импорт.
      <br>
