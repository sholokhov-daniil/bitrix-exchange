...
<template>
  <card-container>
    ...
    <p>
      Класс: <api-link path="classes/Sholokhov-BitrixExchange-Target-UserFields-Enumeration.html">Enumeration</api-link>
      <br>
  ...
  <card-container>
    ...
    <p>
      Импорт значений списка позволяет записывать произвольные в пользовательские свойства (UF).
    </p>
