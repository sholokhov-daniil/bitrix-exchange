...
<template>
  <article>
    ...
    <p>Класс <a href="/api/classes/Sholokhov-BitrixExchange-Target-Highloadblock-Element.html" target="_blank">Element</a></p>

    <h2 class="pt-2">События</h2>
    <ul>
      <li><a href="#before-add">onBeforeHighloadblockElementAdd</a></li>
      <li><a href="#after-add">onAfterHighloadblockElementAdd</a></li>
      <li><a href="#before-update">onBeforeHighloadblockElementUpdate</a></li>
      <li><a href="#after-update">onAfterHighloadblockElementUpdate</a></li>
    </ul>
  </article>

  <article class="card mt-5 mb-5">
    <div class="card-body">
      <h2 class="card-title" id="before-add">onBeforeHighloadblockElementAdd</h2>
      <div class="card-text">
  ...
  <article class="card mt-5 mb-5">
    <div class="card-body">
      <h2 class="card-title" id="after-add">onAfterHighloadblockElementAdd</h2>
      <div class="card-text">
  ...
  <article class="card mt-5 mb-5">
    <div class="card-body">
      <h2 class="card-title" id="before-update">onBeforeHighloadblockElementUpdate</h2>
      <div class="card-text">
  ...
  <article class="card mt-5 mb-5">
    <div class="card-body">
      <h2 class="card-title" id="after-update">onAfterHighloadblockElementUpdate</h2>
      <div class="card-text">
