"use strict";var vn=Object.create;var Q=Object.defineProperty;var mn=Object.getOwnPropertyDescriptor;var dn=Object.getOwnPropertyNames;var fn=Object.getPrototypeOf,kn=Object.prototype.hasOwnProperty;var _n=(s,r,g,i)=>{if(r&&typeof r=="object"||typeof r=="function")for(let p of dn(r))!kn.call(s,p)&&p!==g&&Q(s,p,{get:()=>r[p],enumerable:!(i=mn(r,p))||i.enumerable});return s};var X=(s,r,g)=>(g=s!=null?vn(fn(s)):{},_n(r||!s||!s.__esModule?Q(g,"default",{value:s,enumerable:!0}):g,s));/**
 ...
 * @license MIT License
 */Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const n=require("vue"),wn=require("ua-parser-js"),u="v-code-block";function Z(s){return s===""||s==="prism"?"default":s}function nn(s){return s?"highlightjs":"prism"}const C=s=>{const{str:r,unit:g="px"}=s;if(r!=null&&r!==""&&r!==void 0)return+r?`${Number(r)}${g}`:String(r)},xn=[n.createElementVNode("path",{d:"M224 0c-35.3 0-64 28.7-64 64V288c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H224zM64 160c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H288c35.3 0 64-28.7 64-64V384H288v64H64V224h64V160H64z"},null,-1)],Bn=[n.createElementVNode("path",{d:"M470.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L192 338.7 425.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"},null,-1)],Tn=[n.createElementVNode("path",{d:"M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"},null,-1)],en=n.defineComponent({__name:"StatusIcons",props:{icon:{type:String,required:!0}},setup:s=>(r,g)=>s.icon==="copy"?(n.openBlock(),n.createElementBlock("svg",n.mergeProps({key:0},r.$attrs,{viewBox:"0 0 512 512",xmlns:"http://www.w3.org/2000/svg"}),xn,16)):s.icon==="success"?(n.openBlock(),n.createElementBlock("svg",n.mergeProps({key:1},r.$attrs,{viewBox:"0 0 512 512",xmlns:"http://www.w3.org/2000/svg"}),Bn,16)):s.icon==="failed"?(n.openBlock(),n.createElementBlock("svg",n.mergeProps({key:2},r.$attrs,{viewBox:"0 0 320 512",xmlns:"http://www.w3.org/2000/svg"}),Tn,16)):n.createCommentVNode("",!0)});function Cn(s){return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}const zn={class:"v-code-block--button-copy"},$n={class:"v-code-block--button-run"},Sn={class:"v-code-block--code"},Nn=["textContent"],qn=["innerHTML"],M=((s,r)=>{const g=s.__vccOpts||s;for(const[i,p]of r)g[i]=p;return g})(n.defineComponent({__name:"VCodeBlock",props:n.mergeDefaults({browserWindow:{type:Boolean},cssPath:{},code:{},codeBlockRadius:{},copyButton:{type:Boolean},copyIcons:{type:Boolean},copyTab:{type:Boolean},copyFailedText:{},copyText:{},copySuccessText:{},floatingTabs:{type:Boolean},globalOptions:{type:Boolean},height:{},highlightjs:{type:Boolean},indent:{},label:{},lang:{},languages:{},maxHeight:{},persistentCopyButton:{type:Boolean},prismjs:{type:Boolean},prismPlugin:{type:Boolean},runTab:{type:Boolean},runText:{},tabGap:{},tabs:{type:Boolean},theme:{type:[String,Boolean]}},{browserWindow:!1,cssPath:void 0,code:"",codeBlockRadius:"0.5rem",copyButton:!0,copyIcons:!0,copyTab:!0,copyFailedText:"Copy failed!",copyText:"Copy Code",copySuccessText:"Copied!",floatingTabs:!0,height:"auto",highlightjs:!1,indent:2,label:"",lang:"javascript",maxHeight:"auto",persistentCopyButton:!1,prismjs:!1,prismPlugin:!1,runTab:!1,runText:"Run",tabGap:"0.25rem",tabs:!1,theme:"neon-bunny"}),emits:["run","update:copy-status"],setup(s,{emit:r}){const g=r,i=n.useSlots(),p=n.inject(P,{}),z=s,e=n.ref({...z,...p});let $,S;const v=n.ref(null),h=n.ref("copy"),d=n.ref(""),N=n.ref(!1),q=n.ref(!1),f=n.ref(!1),ln=n.ref("https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build/styles"),D=n.ref("https://cdn.jsdelivr.net/gh/PrismJS/prism@1.29.0/themes"),on=n.ref("https://cdn.jsdelivr.net/gh/PrismJS/prism-themes@1.9.0/themes"),x=n.ref(""),E=n.ref(""),c=n.ref(""),{copyButton:sn,copyIcons:rn,copyTab:H,label:W,runTab:L,tabs:B}=n.toRefs(e.value),tn=n.computed(()=>{let a="";return e.value.highlightjs&&(a=x.value),e.value.prismjs&&e.value.prismPlugin&&(a=v.value),a}),un=n.computed(()=>(a=>{const{isMobile:l,isPrism:t}=a;return{[`${u}`]:!0,[`${u}-mb-5`]:!0,[`${u}--mobile`]:n.unref(l),[`${u}--prismjs`]:n.unref(t),[`${u}--highlightjs`]:!n.unref(t)}})({isMobile:f,isPrism:e.value.prismjs})),gn=n.computed(()=>(a=>{const{copyStatus:l,isMobile:t,persistentCopyButton:o}=a;return{[`${u}--code-copy-button`]:!0,[`${u}--code-copy-button-mobile`]:n.unref(t),[`${u}--code-copy-button-persist`]:n.unref(o),[`${u}--code-copy-button-status-${n.unref(l)}`]:!0}})({copyStatus:h,isMobile:f,persistentCopyButton:e.value.persistentCopyButton})),A=n.computed(()=>(a=>{const{copyStatus:l,highlightjs:t,useTheme:o}=a,b=nn(n.unref(t)),y=Z(n.unref(o));return{[`${u}--button-copy-icon-status-${n.unref(l)}`]:!0,[`${u}--me-1`]:!0,[`${u}--tab-${b}-${y}-icon-status-${n.unref(l)}`]:!0,[`${u}--tab-${b}-${y}-icon`]:!0}})({copyStatus:h,highlightjs:e.value.highlightjs,useTheme:c})),hn=n.computed(()=>(a=>{const{isMobile:l}=a;return{[`${u}--label`]:!0,[`${u}--label-mobile`]:n.unref(l)}})({isMobile:f})),F=n.computed(()=>(a=>{const{highlightjs:l,useTheme:t}=a,o=nn(n.unref(l)),b=Z(n.unref(t));return{[`${u}--tab-${b}`]:!0,[`${u}--tab-${o}-${b}`]:!0}})({highlightjs:e.value.highlightjs,useTheme:c})),I=n.computed(()=>(a=>{const{isLoading:l,useTheme:t}=a,o={width:n.unref(t)==="coy"&&n.unref(l)===!1?"100%":""};return n.unref(t)==="coy"&&(o.padding="1em"),o})({isLoading:q,useTheme:c})),cn=n.computed(()=>(a=>{const{floatingTabs:l,tabGap:t}=a;return{bottom:l?"1px":"0",gap:C({str:n.unref(t)})||"0px"}})({floatingTabs:e.value.floatingTabs,tabGap:e.value.tabGap})),jn=n.computed(()=>(a=>{const{copyTab:l,height:t,maxHeight:o,radius:b,runTab:y,tabs:k,useTheme:_}=a,j=n.unref(b);let m=`${j} 0 ${j} ${j} !important`;return n.unref(k)&&(n.unref(l)||n.unref(y))||(m=j),{borderRadius:m,display:n.unref(_)!=="funky"?"flex":"block",height:C({str:n.unref(t)}),maxHeight:C({str:n.unref(o)}),overflow:"auto"}})({copyTab:H.value,height:e.value.height,maxHeight:e.value.maxHeight,radius:e.value.codeBlockRadius,runTab:L.value,tabs:B.value,useTheme:c})),pn=n.computed(()=>(a=>{const{tabGap:l}=a;return{gap:C({str:n.unref(l)})||"0px"}})({tabGap:e.value.tabGap}));function O(){if(!e.value.prismjs&&!e.value.highlightjs)throw new Error("[vue-code-block]: You must set either the prismjs or highlightjs props.");if(e.value.prismjs&&e.value.highlightjs)throw new Error("[vue-code-block]: You cannot have both prismjs and highlightjs props set at the same time.");if(e.value.highlightjs&&e.value.prismPlugin)throw new Error("[vue-code-block]: Highlight.js does not support PrismJS plugins. Unexpected results may occur. Remove the `prism-plugin` prop from the vue-code-block component.")}function bn(){if(e.value.lang==="json"){const a=e.value.code.toString();return function(l){try{return JSON.parse(l),!0}catch{return!1}}(a)?void(v.value=JSON.stringify(JSON.parse(a),null,e.value.indent)):(e.value.lang="text",void(v.value=a))}v.value=e.value.code}function T(){N.value||(N.value=!0,navigator.clipboard.writeText(v.value).then(()=>{d.value=e.value.copySuccessText,h.value="success",g("update:copy-status",h.value)},a=>{d.value=e.value.copyFailedText,h.value="failed",g("update:copy-status",h.value),console.error("Copy to clipboard failed: ",a)}),setTimeout(()=>{d.value=e.value.copyText,h.value="copy",g("update:copy-status",h.value),N.value=!1},3e3))}function G(){let a="";const l=e.value.highlightjs?"highlightjs":"prism",t=document.getElementsByTagName("head")[0],o=document.createElement("style"),b=document.body.getAttribute("data-v-code-block-theme");let y=`v-code-block--theme-${c.value}-${l}`,k=!0,_=!0,j="",m="";if(y=R(l,y),b===c.value||b===y||typeof c.value=="boolean")return;switch(document.body.setAttribute("data-v-code-block-theme",y),o.setAttribute("type","text/css"),o.setAttribute("data-theme-id",y),o.setAttribute("data-theme","v-code-block--theme-sheet"),c.value){case"neon-bunny":a=`/**
	* MIT License
...
`)}if(!_&&!k)return U(),o.appendChild(document.createTextNode(a)),void t.appendChild(o);const K=R(l,c.value);if(e.value.cssPath!==void 0)m=e.value.cssPath;else switch(l){case"highlightjs":j=`${K}.min.css`,m=`${ln.value}/${j}`;break;case"prism":j=`${K}.css`,m=c.value==="default"?`${D.value}/prism.css`:c.value.includes("themes-")?`${on.value}/${j}`:`${D.value}/prism-${j}`;break;default:j=""}q.value=!0,fetch(m).then(w=>w.text()).then(w=>{U(),o.appendChild(document.createTextNode(w)),t.appendChild(o),q.value=!1}).catch(w=>{const yn=e.value.highlightjs?"Highlight.js":"PrismJS";console.error(`${yn} CDN Error:`,w)})}function J(){const a=wn().device;f.value=a.type==="mobile"}function R(a,l,t=!1){let o=l;return a==="prism"&&(o=o.replace("themes-","prism-"),o=o.replace("prism-prism-","prism-"),o=o.replace("theme-prism-","theme-"),t&&(o=o.replace("prism-prism-",""),o=o.replace("prism-",""))),a==="highlightjs"&&(o=o.replace("base16-","base16/")),o}function U(){const a=document.querySelectorAll('[data-theme="v-code-block--theme-sheet"]');a.length>0&&a.forEach(l=>{l.remove()})}function Y(){bn(),e.value.highlightjs&&import("highlight.js").then(a=>{$=a.default,$.registerLanguage("plain",Cn),x.value=$.highlight(v.value,{language:e.value.lang}).value}).catch(a=>{console.error("Highlight.js import:",{err:a})}),e.value.prismjs&&import("prismjs").then(a=>{S=a.default,x.value=S.highlight(v.value,S.languages[e.value.lang],e.value.lang)}).catch(a=>{console.error("PrismJS import:",{err:a})})}function V(){g("run")}return n.watch(z,()=>{e.value={...z,...p},e.value.code&&Y(),(e.value.theme||e.value.prismjs||e.value.highlightjs)&&(O(),c.value=e.value.theme,G()),e.value.copyText&&(d.value=e.value.copyText),e.value.runText&&(E.value=e.value.runText)}),n.onBeforeMount(()=>{d.value=e.value.copyText,E.value=e.value.runText,O()}),n.onMounted(()=>{c.value=e.value.theme,G(),J(),Y()}),window.addEventListener("orientationchange",()=>{J()}),(a,l)=>(n.openBlock(),n.createElementBlock("div",{class:n.normalizeClass(n.unref(un))},[n.unref(W)||n.unref(B)||n.unref(i).label||n.unref(i).tabs?(n.openBlock(),n.createElementBlock("div",{key:0,class:"v-code-block--header",style:n.normalizeStyle(n.unref(cn))},[n.createElementVNode("div",{class:n.normalizeClass(["v-code-block--label v-code-block--pb-1",n.unref(hn)])},[n.unref(i).label?n.renderSlot(a.$slots,"label",n.normalizeProps(n.mergeProps({key:0},{copyCode:T,copyStatus:n.unref(h),runCode:V})),void 0,!0):(n.openBlock(),n.createElementBlock(n.Fragment,{key:1},[n.createTextVNode(n.toDisplayString(n.unref(W)),1)],64))],2),n.createElementVNode("div",{class:"v-code-block--tabs",style:n.normalizeStyle(n.unref(pn))},[n.unref(i).tabs?n.renderSlot(a.$slots,"tabs",n.normalizeProps(n.mergeProps({key:0},{copyCode:T,copyStatus:n.unref(h),runCode:V})),void 0,!0):(n.openBlock(),n.createElementBlock(n.Fragment,{key:1},[n.unref(H)&&n.unref(B)?(n.openBlock(),n.createElementBlock("div",{key:0,class:n.normalizeClass(["v-code-block--tab",n.unref(F)]),onClick:T},[n.createElementVNode("div",zn,[n.unref(rn)?(n.openBlock(),n.createBlock(en,{key:0,class:n.normalizeClass(["v-code-block--button-copy-icon",n.unref(A)]),icon:n.unref(h)},null,8,["class","icon"])):n.createCommentVNode("",!0),n.createTextVNode(" "+n.toDisplayString(n.unref(d)),1)])],2)):n.createCommentVNode("",!0),n.unref(L)&&n.unref(B)&&!n.unref(f)?(n.openBlock(),n.createElementBlock("div",{key:1,class:n.normalizeClass(["v-code-block--tab v-code-block--tab-run",n.unref(F)]),onClick:V},[n.createElementVNode("div",$n,n.toDisplayString(n.unref(E)),1)],2)):n.createCommentVNode("",!0)],64))],4)],4)):n.createCommentVNode("",!0),n.createElementVNode("div",Sn,[n.createElementVNode("div",{class:n.normalizeClass(["v-code-block--code-copy-button",n.unref(gn)]),onClick:T},[n.unref(i).copyButton?n.renderSlot(a.$slots,"copyButton",n.normalizeProps(n.mergeProps({key:0},{copyStatus:n.unref(h)})),void 0,!0):(n.openBlock(),n.createElementBlock(n.Fragment,{key:1},[n.unref(sn)?(n.openBlock(),n.createBlock(en,{key:0,class:n.normalizeClass(["v-code-block--button-copy-icon",n.unref(A)]),icon:n.unref(h)},null,8,["class","icon"])):n.createCommentVNode("",!0)],64))],2),n.createElementVNode("pre",n.mergeProps(a.$attrs,{class:`language-${n.unref(e).lang}`,style:n.unref(jn)}),[n.createTextVNode("		"),a.prismPlugin?(n.openBlock(),n.createElementBlock("code",{key:0,class:n.normalizeClass(`language-${n.unref(e).lang} ${n.unref(e).browserWindow?"v-code-block--code-browser":""} ${n.unref(e).highlightjs?"hljs":""}`),style:n.normalizeStyle(n.unref(I)),textContent:n.toDisplayString(n.unref(tn))},null,14,Nn)):(n.openBlock(),n.createElementBlock("code",{key:1,class:n.normalizeClass(`language-${n.unref(e).lang} ${n.unref(e).browserWindow?"v-code-block--code-browser":""} ${n.unref(e).highlightjs?"hljs":""}`),style:n.normalizeStyle(n.unref(I)),innerHTML:n.unref(x)},null,14,qn)),n.createTextVNode(`
	`)],16)])],2))}}),[["__scopeId","data-v-51ec5829"]]),an=Object.freeze(Object.defineProperty({__proto__:null,default:M},Symbol.toStringTag,{value:"Module"})),P=Symbol();exports.VCodeBlock=M,exports.codeBlockOptions=P,exports.createVCodeBlock=function(s={}){return{install:r=>{r.provide(P,s),r.component("CodeBlock",n.defineAsyncComponent(()=>Promise.resolve().then(()=>an))),r.component("VCodeBlock",n.defineAsyncComponent(()=>Promise.resolve().then(()=>an)))}}},exports.default=M;
